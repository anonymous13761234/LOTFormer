...
# -----------------------------------------------------------------------------
# Linear Attention options
# -----------------------------------------------------------------------------

_C.MODEL.LA = CN()
_C.MODEL.LA.ALPHA = 4
_C.MODEL.LA.KERNEL_SIZE = 5
_C.MODEL.LA.ATTN_TYPE = 'LLLL'
_C.MODEL.LA.PVT_LA_SR_RATIOS = 1111
_C.MODEL.LA.CSWIN_LA_SPLIT_SIZE = '56-28-14-7'
_C.MODEL.LA.num_refs = 32
_C.MODEL.LA.sink_eps = 1.0
_C.MODEL.LA.sink_max_iter = 5
