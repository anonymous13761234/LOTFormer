...
# from models.performer_attention import FastAttention
...
class FastAttention(nn.Module):
    def __init__(self, dim_heads, n= None, nb_features = None, ortho_scaling = 0, causal = False, generalized_attention = False, kernel_fn = nn.ReLU(), qr_uniform_q = False, no_projection = False):
        super().__init__()
